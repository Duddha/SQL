select distinct "Участок"
                --Для получения суммарных данных по участку комментируем следующую и последнюю строчки 
                ,"Улица"
                ,"Подразделение"
                --Для получения данных по участкам и домам комментируем следующую строчку
                ,"По участку"
                --Для получения суммарных данных по участку комментируем следующую строку и строчку ',"Улица"'
                ,"По улице"
  from (select "Участок",
               "Улица",
               "Подразделение",
               count(1) over(partition by "Участок", "Подразделение") "По участку",
               count(1) over(partition by "Участок", "Улица", "Подразделение") "По улице"
          from (select decode("Улица",
