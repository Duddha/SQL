...
from (       
  ...
  where 
    u.data_uvol between trunc(to_date(&<name="Дата выборки" type="string" hint="ДД.ММ.ГГГ">, 'dd.mm.yyyy'), 'Q') and to_date(&<name="Дата выборки" type="string" hint="ДД.ММ.ГГГ">, 'dd.mm.yyyy')
