select id_tab "Таб.№", fio "Ф.И.О.", 
       id_nalog "Идентификационный код", 
       decode(kto, 1, 'Вышедшие на пенсию до 7.06.2007, стаж >= 6 лет', 
                   2, 'Вышедшие на пенсию после 7.06.2007, стаж >= 15 лет', 
                   3, 'Добавлены персонально') "Примечание"
from (
